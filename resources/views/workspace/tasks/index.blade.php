...
@endphp
    ...
    {{-- ── Page header (Phase 28: standard header; module nav is in the shell tab bar) --}}
    <x-portal.page-header
        title="Tasks"
        :subtitle="$tasks->count() . ' ' . Str::plural('task', $tasks->count())
            . (in_array($role, $draggableRoles) ? ' · drag a card to change its status' : '')"
