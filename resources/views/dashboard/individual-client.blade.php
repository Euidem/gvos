<x-layouts.gvos title="Client Dashboard">

    <div class="mb-6">
        <h2 class="text-2xl font-bold text-slate-800">My Dashboard</h2>
        <p class="text-sm text-slate-500 mt-1">Client Portal — your account overview</p>
    </div>
    ...
    <div class="bg-indigo-50 border border-indigo-200 rounded-xl px-6 py-5 text-sm text-indigo-700">
        ...
        <p class="mt-1 text-indigo-600">
            Client Portal is active. Service requests, communication, and reporting features are planned for Phase 1.
        </p>
    </div>
