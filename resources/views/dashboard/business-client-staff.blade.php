...
@endphp
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
        ...
        <div class="bg-white rounded-xl border border-dashed border-slate-200 px-5 py-4 opacity-50 cursor-not-allowed">
            <p class="text-sm font-semibold text-slate-500">Workspace Access</p>
    ...
    <div class="bg-slate-50 border border-slate-200 rounded-xl px-6 py-5">
        <p class="text-sm font-semibold text-slate-700">Phase 2 — People and Organization Foundation</p>
        <p class="text-sm text-slate-500 mt-0.5">
            Your staff account is active. Workspace access and collaboration features are coming in later phases.
        </p>
    </div>
