...
export default function BusinessClientAdmin() {
    return (
        <AppLayout title="Business Admin Dashboard">
            <div className="max-w-4xl">
                <div className="bg-white rounded-xl border border-slate-200 p-8 mb-6">
                    <div className="flex items-center gap-4 mb-4">
                        ...
                        <div>
                            <h2 className="text-xl font-semibold text-slate-900">GVOS Business Admin Dashboard</h2>
                            <p className="text-slate-500 text-sm">GVOS Client Portal — Business account management</p>
                        </div>
                    </div>
                    <div className="bg-amber-50 border border-amber-200 rounded-lg px-4 py-3">
                        <p className="text-amber-800 text-sm font-medium">Phase 0 Placeholder</p>
                        <p className="text-amber-700 text-sm mt-1">
                            Business admin controls (company overview, staff management, consolidated reports) will be available in Phase 2–7.
                        </p>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    {[
                        ...
                        { label: 'Account Type', value: 'Business Admin', color: 'text-teal-600' },
